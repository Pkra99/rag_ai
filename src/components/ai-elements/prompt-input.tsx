...
export const PromptInput = ({
  ...
  const add = useMemo(() => usingProvider && controller
    ? (files: File[] | FileList) => controller.attachments.add(files)
    : addLocal, [usingProvider, controller, addLocal]);

  const remove = useMemo(() => usingProvider && controller
  ...
  const clear = useMemo(() => usingProvider && controller
  ...
  const openFileDialog = useMemo(() => usingProvider && controller
